            ...
            <div className="max-w-4xl mx-auto w-full pb-16">
                ...
                <GuideSection title="Important Notes & Communication Tips" icon={AlertTriangle} defaultOpen={false}>
                    ...
                    <ul className="list-disc pl-5 text-slate-300 space-y-4 relative z-10">
                        ...
                        <li><strong>Restrict WhatsApp Group Additions:</strong> Harassing agents will often create WhatsApp groups containing you and all your extracted contacts simultaneously to humiliate you. Prevent this instantly: open WhatsApp Settings ➔ Privacy ➔ Groups, and change "Who can add me to groups" from "Everyone" to "My Contacts".</li>
